...
public class Gameplay extends JPanel implements KeyListener, ActionListener{
	...
	public void paint(Graphics g) {
		...
		if(highScores.isEmpty()) {
			g.drawString("High Score: " + this.highScore + " Your Score: " + score, 500, 615);
		}else {
			g.drawString("High Score: " + highScores.get(highScores.size() - 1) + " Your Score: " + score, 500, 615);
		}
		
		
		// Exit to main screen
		g.drawString("Press 'Q' to exit to welcome screen, 'P' to Pause Game", 20, 615);
...
//				ballYdir = -ballYdir; 
//				Use the above line to test, this way u dont have to play the game with the paddle.
			}
		}
